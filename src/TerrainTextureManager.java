...
//            Block, IsoImageBuffer, World, Chunk, 
//            Material
...
public class TerrainTextureManager
{
    ...
    public void func_799_a(IsoImageBuffer isoimagebuffer)
    {
        ...
        int i = isoimagebuffer.chunkX * 16;
        int j = isoimagebuffer.chunkZ * 16;
        int k = i + 16;
        int l = j + 16;
        Chunk chunk = world.getChunkFromChunkCoords(isoimagebuffer.chunkX, isoimagebuffer.chunkZ);
