...
public class AM_BiomeGenTech extends BiomeGenBase
{
    ...
    public AM_BiomeGenTech()
    {
        ...
        spawnableCreatureList.add(new SpawnListEntry(net.minecraft.src.AM_EntityChopper.class, 20));
		spawnableCreatureList.add(new SpawnListEntry(net.minecraft.src.AM_EntityBobby.class, 20));
		...
		spawnableMonsterList.add(new SpawnListEntry(net.minecraft.src.AM_EntitySlider.class, 8));
