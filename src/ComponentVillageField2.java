...
public class ComponentVillageField2 extends ComponentVillage
{
    ...
    {
        StructureBoundingBox structureboundingbox = StructureBoundingBox.func_35747_a(i, j, k, 0, 0, 0, 7, 4, 9, l);
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        if(field_35090_a < 0)
        {
            field_35090_a = func_35075_b(world, structureboundingbox);
            if(field_35090_a < 0)
            {
                return true;
            }
        ...
        func_35011_a(world, structureboundingbox, 0, 1, 0, 6, 4, 8, 0, 0, false);
        ...
        func_35011_a(world, structureboundingbox, 1, 0, 0, 5, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
        func_35011_a(world, structureboundingbox, 1, 0, 8, 5, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
