...
public class ComponentStrongholdStairs extends ComponentStronghold
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        } else
        {
            ...
            func_35018_a(world, Block.stoneBrick.blockID, 0, 2, 6, 1, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 1, 5, 1, structureboundingbox);
            func_35018_a(world, Block.stairSingle.blockID, 0, 1, 6, 1, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 1, 5, 2, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 1, 4, 3, structureboundingbox);
            func_35018_a(world, Block.stairSingle.blockID, 0, 1, 5, 3, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 2, 4, 3, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 3, 3, 3, structureboundingbox);
            func_35018_a(world, Block.stairSingle.blockID, 0, 3, 4, 3, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 3, 3, 2, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 3, 2, 1, structureboundingbox);
            func_35018_a(world, Block.stairSingle.blockID, 0, 3, 3, 1, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 2, 2, 1, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 1, 1, 1, structureboundingbox);
            func_35018_a(world, Block.stairSingle.blockID, 0, 1, 2, 1, structureboundingbox);
            func_35018_a(world, Block.stoneBrick.blockID, 0, 1, 1, 2, structureboundingbox);
