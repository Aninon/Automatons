...
public class AM_WorldGenBigFakeTree extends WorldGenerator
{

    public AM_WorldGenBigFakeTree()
    {
        rand = new Random();
        heightLimit = 0;
        ...
        for(; j1 <= i1; j1++)
        {
            ...
            for(int l1 = -i1; l1 <= i1;)
            {
                ...
                } else
                {
                    ...
                    {
                        worldObj.setBlockAndMetadataWithNotify(ai1[0], ai1[1], ai1[2], l,Meto);
                        l1++;
                    }
                }
            }
    ...
    boolean validTreeLocation()
    {
        ...
        if(i != AutomatonLogger.frass && i != AutomatonLogger.frass2)
        {
            return false;
        }
	...
	int LL=AutomatonLogger.crink; //18
