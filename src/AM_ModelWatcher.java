...
public class AM_ModelWatcher extends ModelBase
{
	...
	public void render(float f, float f1, float f2, float f3, float f4, float f5)
	{
        ...
        leg2.rotationPointY = 2f+MathHelper.cos(f + 3.141593F) * 30F * f1;
