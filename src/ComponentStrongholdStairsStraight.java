...
public class ComponentStrongholdStairsStraight extends ComponentStronghold
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        for(int j = 0; j < 6; j++)
        {
            func_35018_a(world, Block.stairCompactCobblestone.blockID, i, 1, 6 - j, 1 + j, structureboundingbox);
            func_35018_a(world, Block.stairCompactCobblestone.blockID, i, 2, 6 - j, 1 + j, structureboundingbox);
