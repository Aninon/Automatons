...
public class AM_TileEntityTv extends TileEntity
    implements IInventory
{

    public AM_TileEntityTv()
    {
	...
	/**
		...
		GL11.glVertex3f(xCoord+19f,yCoord,zCoord);
		GL11.glVertex3f(xCoord+19f,yCoord+19f,zCoord);
		GL11.glVertex3f(xCoord,yCoord+19f,zCoord);
		GL11.glEnd();*/
