...
public class ComponentVillageField extends ComponentVillage
{
    ...
    public boolean func_35023_a(World world, Random random, StructureBoundingBox structureboundingbox)
    {
        ...
        func_35011_a(world, structureboundingbox, 1, 0, 1, 2, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
        func_35011_a(world, structureboundingbox, 4, 0, 1, 5, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
        func_35011_a(world, structureboundingbox, 7, 0, 1, 8, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
        func_35011_a(world, structureboundingbox, 10, 0, 1, 11, 0, 7, Block.tilledField.blockID, Block.tilledField.blockID, false);
        func_35011_a(world, structureboundingbox, 0, 0, 0, 0, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
        func_35011_a(world, structureboundingbox, 6, 0, 0, 6, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
        func_35011_a(world, structureboundingbox, 12, 0, 0, 12, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
        func_35011_a(world, structureboundingbox, 1, 0, 0, 11, 0, 0, Block.wood.blockID, Block.wood.blockID, false);
        func_35011_a(world, structureboundingbox, 1, 0, 8, 11, 0, 8, Block.wood.blockID, Block.wood.blockID, false);
        ...
        for(int j = 0; j < 9; j++)
        {
            for(int k = 0; k < 13; k++)
            {
                ...
                func_35005_b(world, Block.dirt.blockID, 0, k, -1, j, structureboundingbox);
            }
